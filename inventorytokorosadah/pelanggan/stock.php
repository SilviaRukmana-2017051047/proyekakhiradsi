...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', harga='$harga', stock='$stock' where idx='$idx'");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="exportstkbhn.php"><span>Cetak Laporan Barang</span></a>
                            </li>
                            <li>
                                <a href="presensi.php"><span>Presensi</span></a>
                            </li>
                            <li>
